<?php
	...
	function sendEmailInvite($senderEmail,$email,$db){
		...
		$mail->Body    = "Your friend $senderEmail sent you a request to join him in one of his groups in GMPT!  <a href='http://52.37.56.8/gmpt/api/public/www/'>Visit W3Schools</a> !";
